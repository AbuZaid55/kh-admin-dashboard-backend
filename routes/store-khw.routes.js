...
const { addCategory, getAllCategories, updateCategory, deleteCategory } = require("../controllers/khwaahish/category.controller")
const { addStyle, getAllStyles, updateStyle, deleteStyle } = require("../controllers/khwaahish/styles.controller")
const { addProduct, getProducts, getProductById, updateProduct, deleteProduct, getProductForUpdate } = require("../controllers/khwaahish/product.controller")
