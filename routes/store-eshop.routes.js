...
const { addProduct, getProducts, searchProducts, getProductById, getProductForUpdate, updateProduct, deleteProduct } = require("../controllers/eshop/product.controller")
